...
box_lo0 = np.array([-5e-2, -5e-2, -2e-2])
# Upper corner of the box
box_hi0 = np.array([5e-2, 5e-2, 2e-2])
# Cell size
dx = 1.953125e-4
dz = 2.083333333e-4
...
compute_dz_boosted_frame = False
gamma_boost = 30.0
...
if ndim == 2:
    ...
    # Set of parameters suitable for a 3D simulation on Irene Rome
    ngridpernode = 8.0
    ompnumthreads = 16.0
    mgs = 64.0
    threadspernode = 128.0  # HyperThreading level = 1: no hyperthreading
    distance_between_threads = int(68 * 4 / threadspernode)
    c_option = int(ompnumthreads * distance_between_threads)
